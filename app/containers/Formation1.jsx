...
const Formation1 = () => {
  return (
    <div>
      ...
      <p className={'text-justify ' + cx('content', 'paddingBottom')}>Cette Formation est destinée aux parents d’enfants avec autisme et aux professionnels qui travaillent auprès des personnes avec autisme.</p>
      
            <div className={cx('header')}>Intervenante</div>
      <p className={'text-justify ' + cx('content', 'paddingBottom')}></p>
