...
export const INCREMENT_GOING = 'INCREMENT_GOING';
export const DECREMENT_GOING = 'DECREMENT_GOING';
export const UPDATE_GOING_FAILURE = 'UPDATE_GOING_FAILURE';
export const TYPING_LOCATION = 'TYPING_LOCATION';