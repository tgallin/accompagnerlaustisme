...
export { default as PersonalData} from 'pages/PersonalData';
export { default as ContactDetails} from 'pages/ContactDetails';
export { default as LoginDetails} from 'pages/LoginDetails';
